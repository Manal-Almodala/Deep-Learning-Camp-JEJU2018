...
data_location = "D:/Proyectos/JEJU2018/Code/tuto_UNet/Data1-Cells/train/images/"
...
data_location = "D:/Proyectos/JEJU2018/Code/tuto_UNet/Data1-Cells/train/labels/"
train_data_gt = []  # create an empty list
for dirName, subdirList, _ in sorted(os.walk(data_location)):
    for filename in fileList:
        if ".tif" in filename.lower():  # check whether the file's DICOM
            train_data_gt.append(os.path.join(dirName, filename[:-4] + "_mask.tif"))

train_images = np.zeros(shape=(n, 256, 256, 1))
train_labels = np.zeros(shape=(n, 256, 256, 1))
